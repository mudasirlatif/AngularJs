...
export class HomeComponent implements OnInit {
  ...
  constructor(private dishservice: DishService,
    private promotionservice: PromotionService,private corporateleader: LeaderService, @Inject('BaseURL') private BaseURL) { }
  ...
  ngOnInit() {
    ...
    this.corporateleader.getFeaturedLeader().subscribe(leader => this.leader = leader, errmess => this.leaderErrMess = <any>errmess);
  }
